export default {
  ...
  'app.analysis.authorize': '授权量',
  'app.analysis.authorize-trend': '授权量趋势',
  'app.analysis.authorize-ranking': '授权量排名',
  'app.analysis.total-authorize': '总授权数',
  'app.analysis.day-authorize': '日授权数',
  'app.analysis.visits': '访问量',
  'app.analysis.visits-trend': '访问量趋势',
  'app.analysis.visits-ranking': '访问量排名',
  'app.analysis.day-visits': '日访问量',
  'app.analysis.week': '周同比',
  'app.analysis.day': '日同比',
  'app.analysis.resources': '资源总量',
  'app.analysis.day-resource': '日新增资源',
  ...
  'app.settings.binding.github': '绑定 Github',
  'app.settings.binding.github-description': '当前未绑定 Github 账号',
