export default {
  ...
  'component.globalHeader.search.example1': '權力遊戲',
  'component.globalHeader.search.example2': '烽火危城',
  'component.globalHeader.search.example3': '劍刃風暴',
  ...
  'app.analysis.authorize': '授權量',
  'app.analysis.authorize-trend': '授權量趨勢',
  'app.analysis.authorize-ranking': '授權量排名',
  'app.analysis.total-authorize': '總授權数',
  'app.analysis.day-authorize': '日授權数',
  'app.analysis.visits': '訪問量',
  'app.analysis.visits-trend': '訪問量趨勢',
  'app.analysis.visits-ranking': '訪問量排名',
  'app.analysis.day-visits': '日訪問量',
  'app.analysis.week': '周同比',
  'app.analysis.day': '日同比',
  'app.analysis.resources': '資源總量',
  'app.analysis.day-resource': '日新增資源',
  ...
  'app.settings.binding.github': '綁定 Github',
  'app.settings.binding.github-description': '當前未綁定 Github 賬號',
